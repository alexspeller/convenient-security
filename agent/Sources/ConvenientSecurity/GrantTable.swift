...
/// whose root is the caller or an ancestor of it, minted for the same delivery
/// plan. New consent creates a grant rooted at the caller.
public actor GrantTable {
    ...
    /// grant, restricted to grants minted for the same delivery-plan digest.
